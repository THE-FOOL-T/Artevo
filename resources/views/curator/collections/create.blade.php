...
@section('title', "New Collection — {$museum->name} — Artevo")
...
@section('content')
    <section class="av-section av-section--white" style="padding-top: var(--space-10);">
        <div class="container" style="max-width: 720px;">
            ...
            <p><a href="{{ route('curator.collections.index', $museum) }}" style="color: var(--brass-700); font-weight: 600;">&larr; Back to collections</a></p>

            <x-alert :message="session('error')" type="error" />

            <form action="{{ route('curator.collections.store', $museum) }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <x-card class="mt-6">
                    ...
                    <div class="av-field mt-4">
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name') }}"
                               placeholder="e.g. Ancient Egypt — The New Kingdom" required maxlength="180">
                    ...
                    <div class="av-field mt-4">
                        ...
                        <textarea id="description" name="description" rows="4"
                                  placeholder="Describe the theme, period, or curatorial intent of this collection…">{{ old('description') }}</textarea>
                    ...
                    <div class="av-field mt-4">
                        ...
                        <p style="margin: var(--space-1) 0 0; font-size: var(--text-xs); color: var(--stone-600);">JPG, PNG, or WebP. Max 5 MB. Displayed at 16:9.</p>
                    ...
                    <div style="margin-top: var(--space-4);">
                        <label class="flex gap-3" style="align-items: center; cursor: pointer;">
                            ...
                            <span>
                                ...
                                <span style="font-size: var(--text-sm); color: var(--stone-600);">When checked, anyone can browse this collection at <code>/collections</code>. When unchecked, only you and administrators can see it.</span>
                            </span>
                        </label>
                    </div>
                </x-card>
                ...
                <div class="flex gap-4 mt-6">
                    ...
                    <x-button href="{{ route('curator.collections.index', $museum) }}" variant="outline-dark">Cancel</x-button>
                </div>
            </form>
        </div>
    </section>
