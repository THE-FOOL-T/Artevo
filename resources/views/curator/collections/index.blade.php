...
@section('title', "{$museum->name} — Collections — Artevo")
    ...
    <section class="av-section av-section--white" style="padding-top: var(--space-10);">
        <div class="container">
            ...
            <div class="flex-between" style="margin-top: var(--space-4);">
                ...
                <x-button href="{{ route('curator.collections.create', $museum) }}" variant="primary">New collection</x-button>
            </div>
            ...
            @if($collections->isEmpty())
                <x-card class="mt-8">
                    <p style="margin: 0;">No collections yet. Create the first collection to start grouping this museum's artifacts.</p>
                </x-card>
            @else
                        ...
                        <x-card class="av-card--media">
                            ...
                            <div class="av-card--media__body">
                                ...
                                <div class="flex gap-4">
                                    <a href="{{ route('curator.collections.edit', [$museum, $collection]) }}" style="color: var(--brass-700); font-weight: 600; font-size: var(--text-sm);">Edit &rarr;</a>
