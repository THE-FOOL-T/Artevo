...
{
    /**
     * Note: this request only validates the artifact's own fields.
     * Which museum (curator flow) or collector (collector flow) it
     * belongs to is determined by which route was hit, not by user
     * input — see Curator\ArtifactController and
     * Collector\ArtifactController.
     */
