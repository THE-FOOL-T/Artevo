...
use App\Http\Requests\Admin\UpdateMuseumVerificationRequest;
use App\Models\Museum;
use Illuminate\Http\RedirectResponse;

class MuseumVerificationController extends Controller
{
    public function update(UpdateMuseumVerificationRequest $request, Museum $museum): RedirectResponse
    {
